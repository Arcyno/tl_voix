function [lpc_frames] = mylpc(f_ech,son,frames_length,ordre);
...
% for frame = 1: Nframes  %% attention !!
%     frames(frame,:) = son(frames_length*(frame - 1)/2 + 1: frames_length*(frame + 1)/2);
% end
...
%     end
    acf = xcorr(son_fen, ordre+1, 'biased');
